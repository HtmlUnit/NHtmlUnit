...
{
   public partial class PointerEvent : NHtmlUnit.Javascript.Host.MouseEvent
   {
      static PointerEvent()
      {
         ObjectWrapper.RegisterWrapperCreator((com.gargoylesoftware.htmlunit.javascript.host.PointerEvent o) =>
            new PointerEvent(o));
      }

      public PointerEvent(com.gargoylesoftware.htmlunit.javascript.host.PointerEvent wrappedObject) : base(wrappedObject) {}

      public new com.gargoylesoftware.htmlunit.javascript.host.PointerEvent WObj
      {
         get { return (com.gargoylesoftware.htmlunit.javascript.host.PointerEvent)WrappedObject; }
      }

      public PointerEvent(NHtmlUnit.Html.DomNode domNode, string type, bool shiftKey, bool ctrlKey, bool altKey, int button)
         : this(new com.gargoylesoftware.htmlunit.javascript.host.PointerEvent((com.gargoylesoftware.htmlunit.html.DomNode)domNode.WrappedObject, type, shiftKey, ctrlKey, altKey, button)) {}

      public PointerEvent()
         : this(new com.gargoylesoftware.htmlunit.javascript.host.PointerEvent()) {}
