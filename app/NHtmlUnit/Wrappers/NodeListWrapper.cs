...
namespace NHtmlUnit
{
    public class NodeListWrapper<T> : IList<INode>
    {
        ...
        {
            get { return ObjectWrapper.CreateWrapper<INode>(this.nodeList.item(index)); }
        ...
        public int Count
        {
            get { return this.nodeList.getLength(); }
        }
        ...
        public IEnumerator<INode> GetEnumerator()
        {
            for (int i = 0; i < this.nodeList.getLength(); i++)
                yield return ObjectWrapper.CreateWrapper<INode>(this.nodeList.item(i));
        }
        ...
        {
            return Array.IndexOf(this.ToArray(), item);
        }
